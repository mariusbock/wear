...
for type, include_null in list(itertools.product(types, includes)):
    print("NOW: ", type, include_null)
    if type == 'split_1':
        train = ['sbj_6', 'sbj_7', 'sbj_8', 'sbj_9', 'sbj_10', 'sbj_11', 'sbj_12', 'sbj_13', 'sbj_14','sbj_15', 'sbj_16', 'sbj_17']
        valid = ['sbj_0', 'sbj_1', 'sbj_2', 'sbj_3', 'sbj_4',  'sbj_5']
    elif type == 'split_2':
        train = ['sbj_0', 'sbj_1', 'sbj_2', 'sbj_3', 'sbj_4',  'sbj_5', 'sbj_12', 'sbj_13', 'sbj_14','sbj_15', 'sbj_16', 'sbj_17']
        valid = ['sbj_6', 'sbj_7', 'sbj_8', 'sbj_9', 'sbj_10', 'sbj_11']
    elif type == 'split_3':
        train = ['sbj_0', 'sbj_1', 'sbj_2', 'sbj_3', 'sbj_4', 'sbj_5', 'sbj_6', 'sbj_7', 'sbj_8', 'sbj_9', 'sbj_10', 'sbj_11']
        valid = ['sbj_12', 'sbj_13', 'sbj_14', 'sbj_15', 'sbj_16', 'sbj_17']
    else:
        train = []
        valid = ['sbj_0', 'sbj_1', 'sbj_2', 'sbj_3', 'sbj_4', 'sbj_5', 'sbj_6', 'sbj_7', 'sbj_8', 'sbj_9', 'sbj_10', 'sbj_11', 'sbj_12', 'sbj_13', 'sbj_14', 'sbj_15', 'sbj_16', 'sbj_17']

    sens_header = ['sbj_id', 'right_arm_acc_x', 'right_arm_acc_y', 'right_arm_acc_z', 'right_leg_acc_x', 
    ...
    for i, subject in enumerate(train + valid):
